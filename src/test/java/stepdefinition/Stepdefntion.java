...
//	@When("^user should enter \"([^\"]*)\" from september(\\d+) database$")
//	public void user_should_enter_from_september_database(String Logindata) throws Throwable {
//	switch (Logindata) {
//	case "username":
//	lp.enterUsername(dbp.takedatafromDB("username"));
//	System.out.println("username from DB:" +dbp.takedatafromDB("username"));
...
//
//	case "password" :
//		lp.enterUsername(dbp.takedatafromDB("password"));
//		System.out.println("password from DB:" +dbp.takedatafromDB("password"));
//		break;
//		default :
//		System.out.println("unable to pull data from DB");
